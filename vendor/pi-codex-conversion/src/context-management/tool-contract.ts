...
const HISTORY_FIELDS = Type.Object({
	...
	role: Type.Optional(Type.Union([
		StringEnum(["user", "assistant", "tool", "system", "developer"] as const),
		Type.Null(),
	])),
...
} satisfies Record<"history" | "notes", Record<string, ContextOperation>>;
...
export const HISTORY_ACTIONS = Object.keys(CONTEXT_OPERATIONS.history) as HistoryAction[];
export const NOTES_ACTIONS = Object.keys(CONTEXT_OPERATIONS.notes) as NotesAction[];

export const HISTORY_PARAMETERS = Type.Object(
	{ action: StringEnum(HISTORY_ACTIONS), ...HISTORY_FIELDS.properties },
	{ additionalProperties: false },
);

export const NOTES_PARAMETERS = Type.Object(
	{ action: StringEnum(NOTES_ACTIONS), ...NOTES_FIELDS.properties },
	{ additionalProperties: false },
);
