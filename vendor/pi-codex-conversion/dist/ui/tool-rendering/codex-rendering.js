...
export function renderExecCommandCall(command, state, theme, expanded = false) {
...
function renderExplorationText(actionGroups, state, theme, commands) {
...
function renderCommandText(command, state, theme, expanded) {
...
function formatCommandLines(command, maxLines = 5, maxLength = 100) {
    const lines = command
        .replace(/\t/g, "   ")
        .split("\n")
